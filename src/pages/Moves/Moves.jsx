...
const Moves = () => {
    ...
    const columns = [
        ...
        columnHelper.accessor("action", {
            cell: (info) => <span className="actions flex gap-2"> <LuTruck className="text-red-600 text-lg"/> <MdOutlineDeleteOutline className="text-red-600 text-lg" /> 
            </span>,
            header: "Action",
          }),
                            ...
                            <tbody>
                                {table.getRowModel().rows.length ? (
                                    table.getRowModel().rows.map((row, i) => (
                                        <tr
                                            key={row.id}
                                            className={`${i % 2 === 0 ? "bg-[#F2F2F2] " : "bg-[#FFFFFF] "}`}
                                        >
